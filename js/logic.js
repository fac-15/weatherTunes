...
const weatherFunctions = {
  ...
  getMusic: function(weatherResults) {
    ...
    const xhr = new XMLHttpRequest();
    const url = `https://www.googleapis.com/youtube/v3/search?part=snippet&order=rating&q=${weatherResults + " song lyrics music"}&type=video&videoCaption=closedCaption&videoDefinition=high&videoEmbeddable=true&key=${keys.youtube}`
    ;
